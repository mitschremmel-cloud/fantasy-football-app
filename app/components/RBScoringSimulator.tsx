...
import { RBAnalysisCharts } from './RBAnalysisCharts';

export default function RBScoringSimulator() {
  ...
  const fetchData = async () => {
    ...
    const res = await fetch('/api/nflverse/rb', {
      method: 'POST',
  ...
  return (
    <div className="bg-slate-800 p-6 rounded-lg text-white">
      <h2 className="text-xl font-bold mb-4">RB Scoring Simulator</h2>
