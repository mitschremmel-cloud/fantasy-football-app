...
import { WRAnalysisCharts } from './WRAnalysisCharts';

export default function WRScoringSimulator() {
  ...
  const fetchData = async () => {
    ...
    const res = await fetch('/api/nflverse/wr', {
      method: 'POST',
  ...
  return (
    <div className="bg-slate-800 p-6 rounded-lg text-white">
      <h2 className="text-xl font-bold mb-4">WR Scoring Simulator</h2>
