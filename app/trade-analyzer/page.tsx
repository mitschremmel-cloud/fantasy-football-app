...
return (
  ...
  <div className="flex flex-col gap-4">
    ...
    {/* Zeile 2: Die Buttons (jetzt volle Breite) */}
        ...
        <div className="h-[300px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={plotData} margin={{ bottom: 20 }}>
              ...
              <XAxis dataKey="rank" stroke="#94a3b8" label={{ value: 'Rang / Position', position: 'insideBottom', offset: -10, fill: '#94a3b8' }} />
              <YAxis stroke="#94a3b8" label={{ value: 'Wert', angle: -90, position: 'insideLeft', fill: '#94a3b8' }} />
